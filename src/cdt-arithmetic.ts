...
export function cdtDivide(rdflib: any, a: any, b: any): any | null {
  ...
  if ((parsedB && parsedB.numericValue === 0) || scalarB === 0) return null
  ...
  if (parsedA && parsedB) {
    ...
    // If commensurable but different units, convert first
